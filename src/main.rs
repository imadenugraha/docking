...
fn parse_size_value(size_str: &str) -> f64 {
...
fn parse_percent_value(percent_str: &str) -> f64 {
    percent_str
        .trim()
        .trim_end_matches('%')
        .parse()
...
fn fetch_container_stats(runtime: &str) -> Result<Vec<ContainerStats>, Box<dyn std::error::Error>> {
